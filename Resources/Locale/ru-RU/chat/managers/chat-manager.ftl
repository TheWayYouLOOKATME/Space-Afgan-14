...
chat-speech-verb-name-pigwar = Кряхтит
chat-speech-verb-pigwar-strong = Кричит как свинья при забое
chat-speech-verb-name-oblezliy = Ворчит
chat-speech-verb-poblezliy-strong = Ёбнуто вопит
